...
export function createDefaultSettings(): Settings {
  return {
    ...
    launchAtLogin: false,
    showCompleted: false,
    showOpenTasksInCompletedView: true,
...
function parseSettings(value: unknown): Settings {
  ...
  return {
    ...
    showOpenTasksInCompletedView: typeof item.showOpenTasksInCompletedView === 'boolean' ? item.showOpenTasksInCompletedView : defaults.showOpenTasksInCompletedView,
